...
<q-page class="flex flex-center">
  ...
  <div class="q-gutter-md">
    <div class="q-gutter-lg text-center">
      <q-img src="/icons/Logomarca-AurumDesk.png" height="110px" width="115px" style="text-align: center;"/>
      <q-img src="/icons/Logo-AA-SVG.svg" height="75px" width="110px" style="text-align: center;"/>
    </div>
