<template>
  <q-page class="q-pa-sm" style="background-color: #fff">
    <div class="row items-center">
      <q-btn icon="arrow_left" id="botaoEstilo" class="text-accent" flat to="/settings" />
      <q-icon name="assignment" size="30px" color="secondary" />
      <h1 class="text-h5 text-bold" style="color: black">Usuários Registrados</h1>
      <q-btn id="botaoEstilo" class="text-accent" flat icon="add" @click="criarUsuario" />
    </div>
