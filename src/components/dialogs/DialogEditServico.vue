  ...
  <q-dialog v-model="isOpen" persistent>
    <q-card style="min-width: 400px; border-radius: 12px">
      ...
      <q-card-section class="q-gutter-md">
        ...
        <q-input
          v-model="form.itensRecebidos"
          label="Itens Recebidos"
          type="textarea"
          outlined
          dense
        />
        <q-input v-model="form.descricaoServico" label="Descrição" type="textarea" outlined dense />
        <q-input
        ...
        <q-input v-model="form.statusServico" label="Status do Serviço" outlined dense />
      </q-card-section>
...
watch(
  ...
  (val) => {
    isOpen.value = val
    if (val && props.servico) form.value = { ...props.servico }
  },
)
